...
export async function loader({ request, context }: LoaderFunctionArgs) {
    ...
    return apiJson({ data: snapshot ?? { activeVisitors: 0, viewsLastMinute: 0, viewsInWindow: 0, conversionsInWindow: 0, perMinute: [], topPaths: [], topChannels: [], topReferrers: [], topCountries: [], feed: [], now: Date.now() } });
}
